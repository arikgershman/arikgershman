...
*   **Client Self-Service Portal @ SOS Technology Group:** Developed an automated, multi-tenant self-service platform as a Software Engineer Intern. The portal drastically improved overall operational efficiency and streamlined client interactions by automating complex system processes and optimizing endpoint latency by over 99%. [Showcase](https://github.com/arikgershman/client-self-service-portal-showcase)
*   **MassText CRM for Meor Maryland:** Engineered and deployed a full-stack iOS application for a non-profit organization to manage bulk SMS communications. I built the frontend natively in **Swift** and architected a custom backend server using **Python/Flask**, **SQLite**, **Nginx**, and **Gunicorn** hosted on **DigitalOcean**. To handle production messaging, I integrated the live **Twilio API**, successfully navigating A2P 10DLC registration to ensure compliant, real-world messaging throughput. [Short Demonstration](https://drive.google.com/file/d/1_jQweZbPB7uA-33V6tB76tfRQAppuPNG/view?usp=sharing)
...
![x86-64 Assembly](https://img.shields.io/badge/Assembly-Grey?style=for-the-badge&logo=data-assembly&logoColor=white) 
